<template>
    <footer class="flex-col justify-center gap-4 absolute w-full bg-grey-500 bt-1 border-grey-300 py-3 px-4 footer">
        ...
        <Button @click="() => logout()" startIcon="logout" variant="red">
            Déconnexion
        </Button>
    </footer>
</template>
