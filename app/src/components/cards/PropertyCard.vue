    ...
    <div class="grid columns col-2 items-center py-3 px-5">
      ...
      <div class="flex flex-col gap-2 h-full">
        <div class="flex items-center gap-4">
          <span>{{props.property.number_of_rooms}} pièce(s) - <span>{{props.property.surface_area}}m<span class="text-lg">²</span></span></span>
        ...
        <span class="flex items-center gap-2"><span>Prix: {{props.property.price || 0}}€</span><span>Charges: {{props.property.amount_of_charges || 0}}€</span></span>
      ...
      <!--  col2    -->
      <div class="flex flex-col gap-2 h-full">
        <span>Disponible le {{ formatDate(props.property.availability_date, 'dd/MM/yyyy') }}</span>
        <div v-if="searchLocation">
          <span>Durée trajet depuis <span class="text-yellow">{{searchLocation.address}} - {{searchLocation.city}}</span></span>
        </div>
