            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="grid gap-4" v-else>
                    ...
                    <p class="text-contrast-70">
                        Un email vous a été envoyé avec un lien pour réinitialiser votre mot de
                        passe {{ SITE_NAME }}.

                        Pour choisir un nouveau mot de passe et valider votre demande, cliquez sur le lien dans l'email.
                    </p>
                </div>
            </div>
            <h6 class="text-medium text-sm mt-6 centered gap-2 flex-wrap">Vous n'avez pas perdus votre mot de passe ?
